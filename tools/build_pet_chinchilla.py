...
EYE    = (0.66, 0.07, 0.10)   # 大きなルビーレッドの目（ベージュ・チンチラ）
...
for sx in (-1, 1):
    ...
    # 4本指（前へちょこんと・中指が少し長い）
    fingers = [(0.052, 0.118, 0.030), (0.076, 0.124, 0.036),
               (0.100, 0.124, 0.036), (0.122, 0.116, 0.030)]
    for (fx, fy, fl) in fingers:
        ellipsoid(sx*fx, fy, 0.235, 0.0135, 0.015, fl, PAW, seg=8, ring=6, rotX=-0.35)
# 後足（座って前へ投げ出す）
for sx in (-1, 1):
