...
| ファイル | 容量(MB) | クリップ | mesh/node |
|---|---|---|---|
| `ally_guineapig.glb` | 0.0553 | —（静物） | 1/1 |
| `ally_hedgehog.glb` | 0.1326 | —（静物） | 1/1 |
| `ally_rabbit.glb` | 0.0693 | —（静物） | 1/1 |
| `ally_squirrel.glb` | 0.0748 | —（静物） | 1/1 |
| `enemy_bird.glb` | 0.0813 | —（静物） | 1/1 |
